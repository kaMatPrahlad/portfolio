  ...
  const portfolios = [
    {
      ...
      src:wheather,
      title: "Weather App",
      link: "https://whether-b6ud3zcz7-prahladkamats-projects.vercel.app/" ,
      href: "https://github.com/kaMatPrahlad/Whether-App",
          ...
          {portfolios.map(({ id, src, title,href,link}) => (
            <div key={id} className="shadow-md shadow-gray-600 rounded-lg">
              ...
              <div className="flex items-center justify-center">
                ...
                <a href={link} target="blank" className="w-1/2 px-6 py-3 m-4 duration-200 hover:scale-105">
                  Demo
                </a>
